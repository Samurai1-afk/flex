...
const run = async (client, message) => {
    ...
    if (itens.length < 1) return message.reply({ embeds: [new MessageEmbed().setFooter("∙ Créditos | Humongous ©")
    .setAuthor({
      name: `Bot de Vendas`,
      ...
      .setColor(config.color)
        ...
        if (interaction.customId === 'btn_add') {
            ...
            try {
                ...
                await modalInteraction.reply({ embeds: [new MessageEmbed().setFooter("∙ Créditos | Humongous ©")
                .setAuthor({
                  name: `Bot de Vendas`,
                  iconURL: config.author})
                ...
                await modalInteraction.editReply({ embeds: [new MessageEmbed().setFooter("∙ Créditos | Humongous ©")
                .setAuthor({
                  name: `Bot de Vendas`,
                  iconURL: config.author})
