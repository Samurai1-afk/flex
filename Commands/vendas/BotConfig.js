...
const run = async (client, message, args) => {
    ...
    let Config = await message.reply({ embeds: [new MessageEmbed().setFooter("∙ Créditos | Humongous ©")
    .setAuthor({
      name: `Bot de Vendas`,
      iconURL: config.author}).setThumbnail(message.author.displayAvatarURL({dynamyc: true}))
